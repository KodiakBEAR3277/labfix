<script setup>
// Pages/Admin/Tickets/Show.vue
// Path: resources/js/Pages/Admin/Tickets/Show.vue
// Mirrors: resources/views/admin/tickets/show.blade.php
//
// Quick-status actions (Mark Resolved, Delete) use useForm() — no full reload.
...
// ── Quick status update (Mark as Resolved) ────────────────────────────────────
...
function markResolved() {
  resolveForm.post(`/admin/tickets/${props.ticket.id}`)
}
      ...
      <div class="ticket-header">
        <div class="header-top">
          ...
          <div style="display:flex;gap:1rem;align-items:center;">
            ...
            <Link :href="`/admin/tickets/${ticket.id}/edit`" class="btn btn-primary">Edit Ticket</Link>
          </div>
        </div>
        ...
        <div class="ticket-meta-grid">
          ...
          <div class="meta-item">
            ...
            <div class="meta-value">
              <span class="status-badge" :class="`status-${statusColor(ticket.status)}`">{{ statusLabel(ticket.status) }}</span>
            </div>
          </div>
        ...
        <div class="sidebar">
          ...
          <div class="card">
            ...
            <div class="reporter-info">
              ...
              <p v-if="ticket.reporter?.phone" style="color:#9ca3af;font-size:0.9rem;">{{ ticket.reporter.phone }}</p>
            </div>
          </div>
          ...
          <div v-if="ticket.assigned_to" class="card">
            ...
            <div class="reporter-info">
              ...
              <p v-if="ticket.assigned_to?.email" style="color:#9ca3af;margin-top:0.5rem;font-size:0.9rem;">{{ ticket.assigned_to.email }}</p>
            </div>
          </div>
          <div v-else class="card">
            ...
            <div style="text-align:center;padding:1rem 0;color:#9ca3af;">
              ...
              <Link :href="`/admin/tickets/${ticket.id}/edit`" class="btn btn-primary" style="margin-top:1rem;">Assign Now</Link>
            </div>
          </div>
