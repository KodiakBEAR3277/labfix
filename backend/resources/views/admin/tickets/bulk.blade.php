    ...
    <div class="container">
        ...
        <div class="selection-bar">
            ...
            <div class="selection-actions">
                <a href="{{ route('admin.tickets.index') }}" class="btn btn-outline">Back to Queue</a>
            </div>
        </div>
        ...
        <div class="operations-grid">
            ...
            <div class="operation-card">
                ...
                <form action="{{ route('admin.tickets.bulk-update') }}" method="POST">
                    @csrf
            ...
            <div class="operation-card">
                ...
                <form action="{{ route('admin.tickets.bulk-update') }}" method="POST" onsubmit="return confirm('Are you sure you want to close these {{ $selectedTickets->count() }} tickets?')">
                    @csrf
                    @foreach($selectedTickets as $ticket)
                        <input type="hidden" name="ticket_ids[]" value="{{ $ticket->id }}">
                    @endforeach
