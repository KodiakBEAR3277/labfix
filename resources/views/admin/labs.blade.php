                ...
                <div class="lab-card">
                    <div class="lab-header">
                        ...
                        <div class="lab-actions">
                            ...
                            <button class="action-btn" onclick="toggleLabStatus({{ $lab->id }})">
...
<script>
    ...
    function openAddLabModal() {
        ...
        document.getElementById('labForm').action = '/admin/labs';
    ...
    function editLab(labId) {
        // Fetch lab data and populate form
    ...
    function toggleLabStatus(labId) {
        if (confirm('Are you sure you want to change this lab\'s status?')) {
            fetch(`/admin/labs/${labId}/toggle-status`, {
                method: 'POST',
                headers: {
    ...
    function addEquipment(labId) {
        ...
        document.getElementById('equipmentForm').action = '/admin/equipment';
